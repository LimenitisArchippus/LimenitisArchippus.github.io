"use strict";
const image_elements = [["Media/GalleryImages/ManPlantingTree.jpeg", "Man Planting Tree"],
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (leftButtonElement != null) {
        ...
        console.log("There is no left button element");
    ...
    if (rightButtonElement != null) {
        ...
        console.log("There is no right button element");
});
