function getContactElement(selector: string):JQuery<HTMLElement> {
    const element = $(selector);
    return element;
 
}

const displayContactErrorMsgs = (msgs: string[]) => {
...
const processContactEntries = () => {
    ...
    } else if(email.val()?.toString().match(/[@]/) == null){
...
const resetContactForm = () => {
    ...
    if(contact_form != null) contact_form.trigger("reset");
